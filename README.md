...
- **Project status:** Late Alpha (`0.3.0-alpha`). The runtime is stable enough for export generation and local inspection, but active runtime ↔ UI coupling is still under construction.
...
- **About documentation**: the runtime owns version stamping for the
  ...
  - **Usage**: `python scripts/update_version.py 0.3.0-alpha --build 2025.04 --dashboard-root ../StreamSuites-Dashboard/docs`
