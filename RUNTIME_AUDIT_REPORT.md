...
- **Runtime state export** (`core/state_exporter.py`): Tracks platform/creator status, rumble chat ingest status, and writes `runtime_snapshot.json` via `DashboardStatePublisher`; includes shared instance used by scheduler/app.【F:core/state_exporter.py†L45-L213】【F:core/state_exporter.py†L236-L247】
- **Exports & signals** (`runtime/exports`, `runtime/signals`, `runtime/admin`): Pre-generated JSON snapshots for changelog, polls, tallies, scoreboards, clips, admin manifests, and signal logs remain as static artifacts.【F:runtime/exports/README.md†L1-L16】【F:runtime/signals/chat_events.json†L1-L17】【F:runtime/admin/chat_triggers.json†L1-L41】
